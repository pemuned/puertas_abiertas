...
function que_datos(valor){
  if(valor=='1'){
    $('#ventana_movil_contenido, #contenido_ventana_compu').html('<p style="font-size: 25px;"><b>Action Oriented Approach</b></p><br><p class="text-left"><img src="images/galeria/gal_aspectod.svg"><b>ASPECTOS RELEVANTES</b></p><p style="margin-left: 44px;" class="text-left"><ul class="text-left"><li><span>This multimedia material focuses on the Action Oriented Approach which has been used by the Ministerio de Educación Pública (MEP) in the English Curriculum since 2016.</span></li><!--<li><span>XXXXX</span></li><li><span>XXXXX</span></li>--></ul></p><p class="text-left"><img src="images/galeria/gal_publico.svg"><b>PÚBLICO META</b></p><p style="margin-left: 44px;" class="text-left">Students of the English Teaching for I and II Cycles Major and all those interested in learning English.</p><p class="text-left"><img src="images/galeria/gal_dependencia.svg"><b>DEPENDENCIA</b></p><p style="margin-left: 44px;" class="text-left">School of Social Sciences and Humanities, English Teaching for I and II Cycles Major, English Teaching Department.</p><p class="text-left"><img src="images/galeria/gal_enlace.svg"><b>ENLACE AL MATERIAL</b></p><p style="margin-left: 44px;" class="text-left"><a href=" https://multimedia.uned.ac.cr/pem/action_oriented_approach/pag/home.html" target="_blank">https://<wbr>multimedia.<wbr>uned.<wbr>ac.<wbr>cr/<wbr>pem/<wbr>action_oriented_approach/<wbr>pag/<wbr>home.<wbr>html</a></p>');
  }else if(valor=='2'){
    $('#ventana_movil_contenido, #contenido_ventana_compu').html('<p style="font-size: 25px;"><b>Planeta Planta</b></p><br><p class="text-left"><img src="images/galeria/gal_aspectod.svg"><b>ASPECTOS RELEVANTES</b></p><p style="margin-left: 44px;" class="text-left"><ul class="text-left"><li><span>XXXXX</span></li><li><span>XXXXX</span></li><li><span>XXXXX</span></li></ul></p><p class="text-left"><img src="images/galeria/gal_publico.svg"><b>PÚBLICO META</b></p><p style="margin-left: 44px;" class="text-left">XXXXX</p><p class="text-left"><img src="images/galeria/gal_dependencia.svg"><b>DEPENDENCIA</b></p><p style="margin-left: 44px;" class="text-left">XXXXX</p><p class="text-left"><img src="images/galeria/gal_enlace.svg"><b>ENLACE AL MATERIAL</b></p><p style="margin-left: 44px;" class="text-left"><a href="https://www.uned.cr/qr/XXXXX" target="_blank">https://<wbr>www.<wbr>uned.<wbr>cr/<wbr>qr/<wbr>XXXXX</a></p>');
  }else if(valor=='3'){
    ...
    $('#ventana_movil_contenido, #contenido_ventana_compu').html('<p style="font-size: 25px;"><b>Dark Tourism en Costa Rica</b></p><br><p class="text-left"><img src="images/galeria/gal_aspectod.svg"><b>ASPECTOS RELEVANTES</b></p><p style="margin-left: 44px;" class="text-left"><ul class="text-left"><li><span>Recurso educativo creado por la UNED y el Dr. Xavier Puertas Montoro, basado en una investigación sobre Dark Tourism.</span></li><li><span>Entorno digital en dos dimensiones que permite explorar espacios y acceder a información sobre el Dark Tourism y su presencia en sitios patrimoniales de Costa Rica.</span></li><li><span>Incluye la clasificación de sitios turísticos y rutas para recorridos de Dark Tourism en Costa Rica.</span></li></ul></p><p class="text-left"><img src="images/galeria/gal_publico.svg"><b>PÚBLICO META</b></p><p style="margin-left: 44px;" class="text-left">Estudiantes de la Cátedra de Emprendedurismo Turístico y personas interesadas en el tema y su identificación en Costa Rica.</p><p class="text-left"><img src="images/galeria/gal_dependencia.svg"><b>DEPENDENCIA</b></p><p style="margin-left: 44px;" class="text-left"> Escuela Ciencias Sociales y Humanidades (ECSH), Cátedra de Emprendedurismo Turístico.</p><p class="text-left"><img src="images/galeria/gal_enlace.svg"><b>ENLACE AL MATERIAL</b></p><p style="margin-left: 44px;" class="text-left"><a href="https://multimedia.uned.ac.cr/pem/dark_tourism/" target="_blank">https://<wbr>multimedia.<wbr>uned.<wbr>ac.<wbr>cr/<wbr>pem/<wbr>dark_tourism/</a></p>');
  }else if(valor=='6'){
    ...
    $('#ventana_movil_contenido, #contenido_ventana_compu').html('<p style="font-size: 25px;"><b>Galería virtual de próceres</b></p><br><p class="text-left"><img src="images/galeria/gal_aspectod.svg"><b>ASPECTOS RELEVANTES</b></p><p style="margin-left: 44px;" class="text-left"><ul class="text-left"><li><span>Surge como una opción inmersiva en tres dimensiones para apreciar y divulgar las 32 esculturas de bustos de los próceres de la patria con los que cuenta la UNED.</span></li><li><span>Se acompaña a los bustos de cada prócer con una reseña biográfica.</span></li><li><span>Cuenta con una versión inmersiva de tres dimensiones, una de sitio web y otra de libro digital descargable.</span></li></ul></p><p class="text-left"><img src="images/galeria/gal_publico.svg"><b>PÚBLICO META</b></p><p style="margin-left: 44px;" class="text-left">Comunidad universitaria UNED</p><p class="text-left"><img src="images/galeria/gal_dependencia.svg"><b>DEPENDENCIA</b></p><p style="margin-left: 44px;" class="text-left">Comisión de Arte de la UNED</p><p class="text-left"><img src="images/galeria/gal_enlace.svg"><b>ENLACE AL MATERIAL</b></p><p style="margin-left: 44px;" class="text-left"><a href="https://multimedia.uned.ac.cr/pem/galeriadeproceres/ " target="_blank">https://<wbr>multimedia.<wbr>uned.<wbr>ac.<wbr>cr/<wbr>pem/<wbr>galeriadeproceres/</a></p>');
  }
}
...
function que_imagen(valor){
  if(valor=='1'){
    ...
    $('#imagen_movil').html('<p>Academia Precálculo</p><img src="images/afiches/afi_blanco.png"><div class="boton_ventanas" onclick="'+"javascript:abrir_imagen_movil('0');"+'">Cerrar</div>');
  }else if(valor=='5'){
    ...
    $('#imagen_movil').html('<p>Gira virtual Parque Nacional los Quetzales y Cerro Buenavista</p><img src="images/afiches/afi_blanco.png"><div class="boton_ventanas" onclick="'+"javascript:abrir_imagen_movil('0');"+'">Cerrar</div>');
  }else if(valor=='8'){
    ...
    $('#imagen_movil').html('<p>Feria vocacional en línea 2023</p><img src="images/afiches/afi_blanco.png"><div class="boton_ventanas" onclick="'+"javascript:abrir_imagen_movil('0');"+'">Cerrar</div>');
  }else if(valor=='10'){
    ...
    $('#imagen_movil').html('<p>Fundamentos de Criminología</p><img src="images/afiches/afi_blanco.png"><div class="boton_ventanas" onclick="'+"javascript:abrir_imagen_movil('0');"+'">Cerrar</div>');
  }else if(valor=='12'){
    ...
    $('#imagen_movil').html('<p>Galería virtual de próceres</p><img src="images/afiches/afi_blanco.png"><div class="boton_ventanas" onclick="'+"javascript:abrir_imagen_movil('0');"+'">Cerrar</div>');
  }
}
